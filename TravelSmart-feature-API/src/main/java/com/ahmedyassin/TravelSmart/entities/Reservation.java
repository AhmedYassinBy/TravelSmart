...
public class Reservation {
    ...
    private String childrenAges; // JSON array of children ages: "[3, 7, 12]"
    ...
    private String selectedActivities; // JSON of selected activities

    @Column(name = "price_breakdown", columnDefinition = "TEXT")
    private String priceBreakdown; // JSON of price breakdown
