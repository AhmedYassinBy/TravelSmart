...
import com.ahmedyassin.TravelSmart.services.external.ExternalFlightService;
...
public class FlightController {
    ...
    private final ExternalFlightService flightService;

    /**
     * Rechercher des vols
     * Example: GET
     * /api/flights/search?origin=CDG&destination=JFK&departureDate=2024-12-31&adults=1
     */
    @GetMapping("/search")
