...
public class AuthController {
    ...
    public ResponseEntity<?> requestPasswordReset(@RequestBody PasswordResetRequest request) {
        // Generate token and send email. Do not return token in the response for security.
        userService.requestPasswordReset(request.getEmail());
        return ResponseEntity.ok().body(java.util.Map.of("message", "If an account with that email exists, a password reset link has been sent."));
    }
